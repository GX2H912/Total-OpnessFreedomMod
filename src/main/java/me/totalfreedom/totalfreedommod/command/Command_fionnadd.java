...
@CommandParameters(description = "Fionn's way of Manage admins.", usage = "/<command> <list | clean | reload | clearme [ip] | setrank <username> <rank> | <add | remove | info> <username>>")
public class Command_fionnadd extends FreedomCommand
{
